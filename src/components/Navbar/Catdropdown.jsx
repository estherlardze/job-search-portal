    ...
    <div className="relative ">
      ...
      {isOpen && (
        <div className="absolute top-3 w-[230px] px-6 py-3 bg-white shadow-md z-10 rounded-md">
          ...
          <Link to={`/jobs/teaching-study`}><p className='font-semibold hover:text-blue my-2'>Teaching & Study</p></Link>
          <Link to={`/jobs/photography`}><p className='font-semibold hover:text-blue my-2'>Photography</p></Link>
