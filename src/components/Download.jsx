  ...
  return (
    <div className='bg-download bg-cover bg-center bg-no-repeat w-[100%] h-[80vh]'>
       ...
       <div className='flex gap-1 mb-8'>
         ...
         <h1 className='font-bold text-l 2xl:text-4xl'>DOWNLOAD & ENJOY</h1>
        </div>
        <h1 className='text-4xl md:text-5xl 2xl:text-6xl font-semibold leading-16 lg:w-[50%]'>
          Get the Template Job Search App
        </h1>
        <p className='my-8 text-lg font-semibold lg:w-[50%]'>It is a long established fact that a reader will be distracted
         by the real conten of a page when looking at its layout</p>
         <div className='flex gap-2 lg:gap-6 mt-12'>
